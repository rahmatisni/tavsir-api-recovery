...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('tavsir')->group(function () {
        ...
        Route::get('/order-list', [App\Http\Controllers\API\TavsirController::class,'rderList']);
        ...
        Route::post('/payment-order', [App\Http\Controllers\API\TavsirController::class,'aymentOrder']);
