...
class OrderSupertenantResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'detil' => OrderDetilSupertenantResource::collection($this->detil)->collection->groupBy('product.tenant.name')->toArray()
        ];
    }
}
