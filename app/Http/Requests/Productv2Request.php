...
class ProductV2Request extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $rule = [
            ...
            'sku' => 'required|string|max:20|unique:ref_product,sku,NULL,id,deleted_at,'.$this->id.',tenant_id,'.auth()->user()->tenant_id.',type,'.ProductType::BAHAN_BAKU,
            'name' => 'required|string|max:50',
            'photo' => 'nullable|max:5000',
            'price' => 'required|numeric|min:100|max:1000000',
            'price_capital' => 'required|numeric|min:100|max:1000000',
