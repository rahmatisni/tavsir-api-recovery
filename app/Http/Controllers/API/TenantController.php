...
class TenantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $filterAs = $request?->filteras;

        $businessStatus = $filter['status_perusahaan'] ?? false;
       
        $data = Tenant::with('business', 'rest_area', 'ruas', 'order', 'category_tenant')->myWheres($filter)->myWhereLikeStartCol($filterLike)->myWhereLike($filterAs)
