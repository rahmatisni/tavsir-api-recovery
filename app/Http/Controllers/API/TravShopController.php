...
class TravShopController extends Controller
{
    ...
    function cek ()
    {
        ...
        */
        $ip_interface='transaksi.kiosbank.com';
        $port_interface='17409';
        ...
        $auth_query=$this->auth_response($auth_sorted,'/Services/getCurrentDeposit','POST');
    ...
    {
       dd($this->kiosBankService->cekDeposit());
