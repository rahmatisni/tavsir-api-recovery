    ...
    public function uangelEktronik($data)
    {
        ...
        if($res_json['rc'] == '00')
        {
            if ($res_json['productID'] == '520021' || $res_json['productID'] == '520011') {
                ...
                $res_json['data']['data']['idPelanggan'] = $res_json['data']['noHandphone'] ?? $res_json['data']['idPelanggan'];
                $res_json['data']['data']['noReferensi'] = $res_json['referenceID'] ?? $res_json['data']['noReferensi'];
                $order->save();
